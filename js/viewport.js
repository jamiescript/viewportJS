...
var url = window.location.pathname,
    ...
    deviceList.innerHTML = '<div class="device-list">\
    <button class="js-iphone-portrait">Iphone Portrait</button>\
    <button class="js-iphone-landscape">Iphone Landscape</button>\
    <button class="js-ipad-portrait">Ipad Portrait</button>\
    <button class="js-ipad-landscape">Ipad Landscape</button>\
    </div>\
    <button class="js-device-slider device-icon">device?</button>';
